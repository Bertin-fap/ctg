...
from ctg.ctgfuncts.ctg_count_participation import inscrit_sejour


def inscrit_sejour_(file:pathlib.WindowsPath,no_match:list,df_effectif):
...
def count_participation(path:pathlib.WindowsPath,
    ...
    for sejours_xlsx in sejours_xlsx:
        ...
        dg = pd.read_excel(path_file_xlsx)
        df_list.append(dg)
...
def count_participation_old(path:pathlib.WindowsPath,
                        ctg_path:pathlib.WindowsPath,
                        year:str,
